...
def main() -> None:
    ...
    report.append("")
    report.append("Generated by `scripts/independent_data_audit/consistency_check.py`. This audit did not import, modify, or regenerate any files under `scripts/parsers/`.")
    report.append("")
    report.append("## Scope")
    report.append("")
